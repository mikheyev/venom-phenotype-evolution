...
```{r}
dat<-read.csv("./data/BPP_OUwie_ManyOptions_optima.csv")
dat$BPP.CNP<-NULL
dat$Reg2<-NULL
dat$Reg3<-NULL
dat
...
```{r}
dat<-read.csv("./data/CRISP_OUwie_ManyOptions_optima.csv")
dat$CRISP<-NULL
dat$Reg2<-NULL
dat$Reg3<-NULL
dat
...
###CTL
```{r}
dat<-read.csv("./data/CTL_OUwie_ManyOptions_optima.csv")
dat$Reg2<-NULL
dat$Reg3<-NULL
```
...
```{r}
dat<-read.csv("./data/GF_OUwie_ManyOptions_optima.csv")
dat$Reg2<-NULL
dat$Reg3<-NULL
```
...
```{r}
dat<-read.csv("./data/KSPI_OUwie_ManyOptions_optima.csv")
dat$Reg2<-NULL
dat$Reg3<-NULL
```
...
```{r}
dat<-read.csv("./data/LAAO_OUwie_ManyOptions_optima.csv")
dat$Reg2<-NULL
dat$Reg3<-NULL
```
